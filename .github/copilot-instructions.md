...
| Base URL | `process.env.BASE_URL` — **always use this, never hardcode the domain** |
...
3. **BASE_URL env var is the authoritative domain.** All absolute URLs in meta tags, sitemap, robots.txt, PDF cover, and email links use `process.env.BASE_URL`. Target domain: `tradmedint.com` (migration pending — see `docs/domain-migration.md`).
...
| Paper `_id` | DOI | Title |
|---|---|---|
| `69f950f7...` | `10.5281/zenodo.20118137` | Modern Consumption Patterns |
| `6a017f00...` | `10.5281/zenodo.20117947` | Archetiq Archetype Blueprint |
