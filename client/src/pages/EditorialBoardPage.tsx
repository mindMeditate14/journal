...
// Add board members here as you recruit them
const BOARD_MEMBERS: BoardMember[] = [
  // Example — replace with actual members:
  // { name: 'Prof. Dr. Xxx Yyy', title: 'Professor of Ayurveda', institution: 'University of Xxx', country: 'India' },
];
      ...
      <section className="bg-gradient-to-br from-indigo-900 to-violet-900 text-white">
        <div className="max-w-5xl mx-auto px-6 py-14">
          ...
          <p className="text-indigo-200 text-lg max-w-2xl leading-relaxed">
            TradMed International is guided by an editorial team of experts in traditional, complementary,
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 space-y-12">
        ...
        <section>
          ...
          {BOARD_MEMBERS.length > 0 ? (
            ...
            <div className="bg-white border border-dashed border-gray-300 rounded-xl p-10 text-center text-gray-400 text-sm">
              Editorial board members are being appointed. Announcements will be made shortly.
            </div>
          )}
        </section>
        ...
        <section>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <p className="font-bold text-gray-900 text-base">Mind Meditate Resources</p>
            <p className="text-sm text-gray-600 mt-1">
              H-07-03, Jalan Blok H, Pusat Komersial Dataran Ecohill,<br />
              Jalan Ecohill 1/2, Semenyih, 43500 Semenyih,<br />
              Selangor, Malaysia
            </p>
            <p className="text-sm text-gray-600 mt-3">
              <strong>Journal Website:</strong>{' '}
              <a href="https://tradmedint.com" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">
                tradmedint.com
              </a>
            </p>
            <p className="text-sm text-gray-600">
              <strong>Contact:</strong>{' '}
              <a href="mailto:editor@tradmedint.com" className="text-indigo-600 hover:underline">
                editor@tradmedint.com
              </a>
            </p>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-indigo-600 to-violet-600 rounded-2xl p-8 text-white text-center">
          ...
          <a
            href="mailto:editor@tradmedint.com?subject=Editorial Board Application — TradMed International"
