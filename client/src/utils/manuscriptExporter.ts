...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>Generated by Traditional Medicine International - ${new Date().toLocaleDateString()} - Please review all sections before journal submission</p>
    </div>
  </div>
</body>
</html>`;
...
export class ManuscriptExporter {
  ...
  static generateWordXML(data: ManuscriptExportData): string {
    ...
    const bodyContent = `
      ...
      <w:p><w:pPr><w:jc w:val="center"/></w:pPr><w:r><w:rPr><w:i/><w:sz w:val="16"/></w:rPr><w:t>Generated by Traditional Medicine International - ${new Date().toLocaleDateString()}</w:t></w:r></w:p>
    `;
...
<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  static exportMarkdown(data: ManuscriptExportData, filename = "manuscript.md") {
    ...
    lines.push(`\n${divider}`);
    lines.push(`Generated by Traditional Medicine International - ${new Date().toLocaleDateString()}`);
